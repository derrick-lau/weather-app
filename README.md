...
Then, the application presents the CSV data in a table on a grid pane with a search field which can filter the data by station. Tables allow users sort and compare the data based on whichever properties they want.
Search fields allow users to search data accurately and they work well with tables.
...
The data is presented in a Line chart. Compared to other types of chart like bar chart or area chart, line charts can indicate and compare trends between legends clearly.
...
<br />
<img src="https://i.imgur.com/rEwVpEY.png" alt="Image of Overview" width="450"/>
...
<br />
<img src="https://i.imgur.com/qzriIop.png" alt="Image of Monthly Records" width="450"/>
